...
model_name = "tflite movenet_thunder_float16"

if "tflite" in model_name:
    if "movenet_thunder_float16" in model_name:
    ...
    interpreter = tf.lite.Interpreter(model_path="/Users/jerrywang/PycharmProjects/body detection/lite-model_movenet_singlepose_thunder_tflite_float16_4.tflite")
...
while True:
    ...
    # Resize and pad the frame to match the expected input size
    ...
    # Display the frame with keypoints overlaid
